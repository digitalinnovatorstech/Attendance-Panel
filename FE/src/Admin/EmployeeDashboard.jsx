...
function EmployeeDashboard() {
  ...
  // Filter out admin and superuser from employeeData
  const filteredEmployeeData = employeeData.filter(emp => !emp.is_staff && !emp.is_superuser);

  // Transform data into a consistent format
  const transformedData = React.useMemo(() => {
    if (!filteredEmployeeData || !Array.isArray(filteredEmployeeData)) return [];

    return filteredEmployeeData.map((emp) => {
